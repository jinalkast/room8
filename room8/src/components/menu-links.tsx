...
import { BotMessageSquare, CalendarCheck, Cctv, House, HousePlus, Receipt, Settings } from 'lucide-react';
...
const MenuLinks = () => {
  ...
  const HOUSE_PAGES = {
    ...
    cleanlinessManager: { path: '/cleanlinessManager', icon: <Cctv />, title: 'Cleanliness Manager' }
  };
