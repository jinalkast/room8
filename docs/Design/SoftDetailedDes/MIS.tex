...
\begin{itemize}
\item SUPABASE\_API\_KEY: Key required to interface with the Supabase backend, which stores bill-related data.
\end{itemize}
...
% MIS of Cleanliness Management Module
...
\begin{itemize}
\item SUPABASE\_API\_KEY: Key required to interface with the Supabase backend, which stores mess-related data.
\end{itemize}
