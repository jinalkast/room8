...
\item[Services:]Captures images on camera system to be uploaded and used for cleanliness detection algorithm.
...
\begin{description}
\item[Secrets:]Uploads image of before and after state of shared space.
