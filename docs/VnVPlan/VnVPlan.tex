...
\begin{center}
  \testcase{
    \textbf{FST-UAHM-1} & \textbf{User authentication workflow}\\\hline

    \textbf{Description} & Tests if users are able to create an account, get redirected to their dashboard, log out, then log back in \\ 

    \textbf{References} & FR211, FR212, FR213 \\ 
  ...
  \testcase{
    \textbf{FST-UAHM-2} & \textbf{TODO}\\\hline
...
\begin{center}
  \testcase{
    \textbf{FST-TODO} & \textbf{TODO}\\\hline
