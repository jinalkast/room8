  ...
  \item \textbf{S.2.1 - User Authentication and House Management}
  	\begin{itemize}
  		...
  		\begin{itemize}
            ...
            \item \textbf{FR212:} The system shall allows users to log out of their account.
            \item \textbf{FR213:} The system shall allow users to create a home group using the home name, address, and number of roommates.
            \item \textbf{FR214:} The system shall allow users to invite other users to join their home group.
            \item \textbf{FR215:} The system shall allow users to view the list of users in their home group.
            \item \textbf{FR216:} The system shall allow users to remove users from their home group.
            \item \textbf{FR217:} The system shall allow users to leave their home group.
            \item \textbf{FR218:} The system shall allow users accept or decline invitations to homes.
  	...
  	\begin{itemize}
  		\item \textbf{Functional Requirements:}
  		\begin{itemize}
  			\item \textbf{FR231:} The system shall display the current cleanliness score of the shared living space.
            \item \textbf{FR232:} The system shall display the detected messes in the shared living space.
            \item \textbf{FR233:} The system shall allow users to view the cleanliness score of other users.
            \item \textbf{FR234:} The system shall allow users to view the pending tasks of other users.
  		\end{itemize}
  		\item \textbf{Non-Functional Requirements:}
  		\begin{itemize}
  	...
  	\begin{itemize}
  		...
  		\begin{itemize}
            ...
            \item \textbf{FR243:} The system shall allow users to input chore details (name, description, time, frequency, assigned users, etc.).
            \item \textbf{FR244:} The system shall save the chore and send reminders to the assigned users.
  	...
  	\begin{itemize}
  		...
  		\begin{itemize}
            ...
            \item \textbf{FR252:} The system shall allow users to view what he owes other housemates.
