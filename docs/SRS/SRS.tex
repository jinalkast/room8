...
\begin{center}
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        \makecell{Harshil P.} & 2025-04-04 & Removed and modified cleanliness manager FRs and NFRs & 1.0\\
        \hline
        \makecell{Jane K.} & 2025-04-04 & Removed redundant details for readability & 1.0\\
        \hline
        \makecell{Jane K.} & 2025-04-04 & Added lead-ins for figures and tables & 1.0\\ 
        \hline
    \end{tabular}
\end{center}
...
\begin{benefit}\label{benefit:first}
Ease of managing household duties due to the presence of a centralized application.
\end{benefit}
...
%---------------------------------
The following is a use-case diagram conveying the ways the Room8 app system can be used by a group of roommates.
\begin{figure}[H]
...
The following figure conveys how technical app components relate to each other.
...
The following table classifies requirements as belonging to different modules and levels of importance, and also justifies why they match their classes. 
\begin{table}[H]
    \flushleft
