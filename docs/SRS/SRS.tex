...
%---------------------------------
\begin{flushleft}
  \item \textbf{S.2.1 Front-End Cluster}
  \begin{itemize}
  	\item \textbf{S.2.1.1 - User Authentication and House Management}
  	\begin{itemize}
  		...
  		\end{itemize}
  	\end{itemize}
  	\item \textbf{S.2.1.2 - ChatBot Configuration}
  	\begin{itemize}
  		\item \textbf{Functional Requirements:}
  		\begin{itemize}
  			\item \textbf{FR1 - Sample:}
  		...
  		\end{itemize}
  	\end{itemize}
  	\item \textbf{S.2.1.3 - Cleanliness Manager}
  	\begin{itemize}
  		\item \textbf{Functional Requirements:}
  		\begin{itemize}
  			\item \textbf{FR1 - Sample:}
  		...
  		\end{itemize}
  	\end{itemize}
  	\item \textbf{S.2.1.4 - Schedule Configuration}
  	\begin{itemize}
  		\item \textbf{Functional Requirements:}
  		\begin{itemize}
  			\item \textbf{FR1 - Sample:}
  ...
  \begin{itemize}
  	...
  	\end{itemize}
  \end{itemize}
  \item \textbf{S.2.3 Hardware Cluster}
  \begin{itemize}
  	\item \textbf{S.2.3.1 - Camera + Sensors}
  	\begin{itemize}
  		\item \textbf{Functional Requirements:}
  		\begin{itemize}
  			\item \textbf{FR1 - Sample:}
