...
\\
\textbf{Project Manager: }Responsible for making sure Room8 project is operating smoothly. Ensures resources being allocated efficiently, issues on Github are being solved, project tasks are being tracked and main point of contact between stakeholders and developers.\\
\\
\textbf{Software Developer: }Developing and making sure Room8 application meets specifications, requirements and the specified tasks. Solves issues on Github and implementation of core functionalities.\\
\\
